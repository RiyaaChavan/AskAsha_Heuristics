  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="calendar-dialog-description">Download the ICS file for the full roadmap with all phases (recommended), or add a summary to your online calendar.</p>
