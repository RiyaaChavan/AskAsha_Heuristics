      ...
      {dimensions.width > 0 && dimensions.height > 0 && (
        ...
        >
          <motion.div
            ...
            animate={{ // Change from whileInView to animate for more reliable animation
          ...
          <motion.div
            ...
            initial={{ opacity: 0 }}
            animate={{ // Change from whileInView to animate
              opacity: 1,
          ...
          >
            <Pointer
              className={cn("pointer-icon", pointerClassName)}
            />
          </motion.div>
        </motion.div>
      )}
